package ie.panoptes.constants;

public class IOTestsConfig {
	
	private IOTestsConfig(){
	...
	public static final String TEST_IMAGE_CROWD = "crowd.jpg";
	public static final String TEST_BACK_OF_SOMEONES_HEAD = "back_of_head.jpg";
